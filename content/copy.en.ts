...
export const en: Copy = {
  ...
  admin: {
    ...
    batchIssued: "Issued {n} serials",
    batchFailed: "Batch issue failed",
    copyAll: "Copy all",
    manage: "Manage",
    manageTitle: "Issued serials",
    manageDescription: "Every serial + magic word, with whether it's been used.",
    manageRefresh: "Refresh",
    manageEmpty: "No serials issued yet.",
    ...
    used: "Used",
    unused: "Unused",
    searchPlaceholder: "Search serial, magic word, or nickname",
    dangerZone: "Danger zone",
    resetTitle: "Reset all serials",
    resetHint:
